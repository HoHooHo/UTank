...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaLoaderWrap.Register(L);
		LuaBehaviourWrap.Register(L);
		LuaHelperCSWrap.Register(L);
		ResManagerWrap.Register(L);
		UIListWrap.Register(L);
		SchedulerCSWrap.Register(L);
		ColorEffectWrap.Register(L);
		GradientWrap.Register(L);
		PanelWrap.Register(L);
		PrefabInPrefabWrap.Register(L);
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("ColorEffect");
		ColorEffect_BlendTypeWrap.Register(L);
		ColorEffect_ColorFilterTypeWrap.Register(L);
		L.EndModule();
		L.BeginModule("DG");
