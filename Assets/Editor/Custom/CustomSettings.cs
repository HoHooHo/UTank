...
public static class CustomSettings
{
    ...
    {                
		...
		_GT(typeof(LuaHelperCS)),
		_GT(typeof(ResManager)),
        _GT(typeof(UIList)).SetBaseType(typeof(UnityEngine.MonoBehaviour)),
        _GT(typeof(Text)),
		_GT(typeof(SchedulerCS)),
        _GT(typeof(ColorEffect)),
        _GT(typeof(ColorEffect.BlendType)),
        _GT(typeof(ColorEffect.ColorFilterType)),
        _GT(typeof(Gradient)),
         _GT(typeof(Panel)),
        ...
        //_GT(typeof(TrailRenderer))
          ...
          //_GT(typeof(RectTransform)).SetBaseType(typeof(Transform)),    
